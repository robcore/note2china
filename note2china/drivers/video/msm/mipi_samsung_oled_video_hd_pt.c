...
unsigned char SEQ_MAGNA_GP[] = {
	0xB0,
	0x0E,
};

unsigned char SEQ_MAGNA_REFRESH_DISABLE[] = {
	0xDD,
	0x00, 0x00,
};
...
static unsigned char elvss_control_set_20[] = {
	0xB2, 0x20,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_30[] = {
	0xB2, 0x20,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_40[] = {
	0xB2, 0x20,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_50[] = {
	0xB2, 0x1F,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_60[] = {
	0xB2, 0x1F,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_70[] = {
	0xB2, 0x1F,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_80[] = {
	0xB2, 0x1E,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_90[] = {
	0xB2, 0x1E,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_100[] = {
	0xB2, 0x1C,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_110[] = {
	0xB2, 0x1B,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_120[] = {
	0xB2, 0x19,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_130[] = {
	0xB2, 0x17,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_140[] = {
	0xB2, 0x16,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_150[] = {
	0xB2, 0x14,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_160[] = {
	0xB2, 0x12,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_170[] = {
	0xB2, 0x10,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_180[] = {
	0xB2, 0x0F,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_190[] = {
	0xB2, 0x15,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_200[] = {
	0xB2, 0x14,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_210[] = {
	0xB2, 0x13,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_220[] = {
	0xB2, 0x12,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_230[] = {
	0xB2, 0x11,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_240[] = {
	0xB2, 0x10,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_250[] = {
	0xB2, 0x10,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};

static unsigned char elvss_control_set_300[] = {
	0xB2, 0x0B,
	0xB4, 0xA0, 0x00, 0x00, 0x00, 0x00
};


static unsigned char *ELVSS_CONTROL_TABLE[ELVSS_STATUS_MAX] = {
...
static struct dsi_cmd_desc samsung_panel_ready_to_read_mtp_magna_cmds[] = {
...
static struct dsi_cmd_desc samsung_panel_ready_to_on_magna_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,
		sizeof(SEQ_MAGNA_GP), SEQ_MAGNA_GP},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
		sizeof(SEQ_MAGNA_REFRESH_DISABLE), SEQ_MAGNA_REFRESH_DISABLE},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
...
static int get_elvss_value(int bl_level)
{
	int elvss_level;
	...
	case 0 ... 20:
		...
		break;
	case 21 ... 39:
		elvss_level = ELVSS_STATUS_30;
		break;
	case 40 ... 49:
		elvss_level = ELVSS_STATUS_40;
		break;
	case 50 ... 59:
		elvss_level = ELVSS_STATUS_50;
		break;
	case 60 ... 69:
		elvss_level = ELVSS_STATUS_60;
		break;
	case 70 ... 79:
		elvss_level = ELVSS_STATUS_70;
		break;
	case 80 ... 89:
		elvss_level = ELVSS_STATUS_80;
		break;
	case 90 ... 99:
		elvss_level = ELVSS_STATUS_90;
		break;
	case 100 ... 109:
...
static int set_elvss_level(int bl_level, int lcd_type)
{
	int elvss_val;
	
	elvss_val = get_elvss_value(bl_level);
	
	if(lcd_type == LDI_TYPE_MAGNA) {
		elvss_update_cmds[0].payload = ELVSS_CONTROL_TABLE[elvss_val];
		elvss_update_cmds[0].dlen = 8;
	} else {
		elvss_update_cmds[0].payload[2] = GET_ELVSS_ID[elvss_val];
	}
...
static int set_acl_on_level(int bl_level)
{
	...
	if(cd < GAMMA_50CD) {
		return 1;
	} else if (cd < GAMMA_40CD) {
		acl_on_cmds[0].payload = acl_cutoff_33;
...
static int prepare_brightness_control_cmd_array(struct illuminance_table *bright_table, int bl_level, int lcd_type)
{
	...
	if(lcd_type == LDI_TYPE_MAGNA) {
		aid_ctrl_cmds[0].payload = bright_table[cd].b3;
		aid_ctrl_cmds[0].dlen = 3;
		
		magna_backlight_ctrl_cmds[1].payload = bright_table[cd].gamma_setting;
		magna_backlight_ctrl_cmds[1].dlen =  33;
	} else {
...
static struct mipi_panel_data mipi_pd = {
	...
	.ready_to_read_mtp = {samsung_panel_ready_to_read_mtp_magna_cmds
				, ARRAY_SIZE(samsung_panel_ready_to_read_mtp_magna_cmds)},	
