...
static int switch_to_d3(struct sii8240_data *sii8240)
{
	...
	sii8240->pwr_state = POWER_STATE_D3;
...
{
	u8 plim;
	u8 dev_cat = sii8240->regs.peer_devcap[MHL_DEVCAP_DEV_CAT];
...
static void sii8240_detection_restart(struct work_struct *work)
{
	...
	sii8240->pwr_state = POWER_STATE_NONE;
					...
					unsigned long event, void *ptr)
{
	...
	if (sii8240->state == STATE_MHL_DISCOVERY_SUCCESS) {
		...
		sii8240->pwr_state = POWER_STATE_D0;
	}
