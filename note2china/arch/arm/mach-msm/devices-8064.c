...
#define SGLTE2_QSC2AP_STATUS	36 
#define SGLTE2_QSC2AP_ERRFATAL	37 
#define SGLTE2_PM2QSC_PWR_EN		PM8921_GPIO_PM_TO_SYS(8) 
#define SGLTE2_PM2QSC_SOFT_RESET	PM8921_GPIO_PM_TO_SYS(12) 
#define SGLTE2_PM2QSC_KEYPADPWR		PM8921_GPIO_PM_TO_SYS(16) 
...
static struct resource sglte2_qsc_resources[] = {
	...
	},
	{
		...
		.name	= "AP2QSC_KPDPWR_N",
		.flags	= IORESOURCE_IO,
	},
	{
		.start	= SGLTE2_PM2QSC_SOFT_RESET,
		.end	= SGLTE2_PM2QSC_SOFT_RESET,
		.name	= "AP2QSC_SOFT_RESET",
		.flags	= IORESOURCE_IO,
	},
	{
		.start	= SGLTE2_PM2QSC_PWR_EN,
		.end	= SGLTE2_PM2QSC_PWR_EN,
		.name	= "AP2QSC_PMIC_PWR_EN",
		.flags	= IORESOURCE_IO,
	},
};
