...
#define GPIO_TFLASH_LS_EN		PM8921_GPIO_PM_TO_SYS(29)
#endif
#define GPIO_NFC_IRQ		PM8921_GPIO_PM_TO_SYS(29)
#if !defined(CONFIG_MACH_JF_SGLTE) //jf_sglte bt_en
#define GPIO_NFC_FIRMWARE	PM8921_GPIO_PM_TO_SYS(25)
#endif
#ifdef CONFIG_MACH_JF_SGLTE
#define GPIO_CAM_FLASH		PM8921_GPIO_PM_TO_SYS(11)
#else
...
#if defined(CONFIG_MACH_JF_SGLTE)
#define GPIO_MHL_SDA                    6
#define GPIO_MHL_SCL                    7
#else
...
#if defined(CONFIG_MACH_JF_SGLTE)
#define GPIO_WL_REG_ON PM8921_GPIO_PM_TO_SYS(17)
#define GPIO_BT_EN PM8921_GPIO_PM_TO_SYS(25)
enum {
	FPGA_GPIO_VPS_SOUND_EN = 0,
	FPGA_GPIO_PEN_FWE1,
	FPGA_GPIO_PEN_RESET,
	FPGA_VSIL_A_1P2_EN,
	FPGA_GPIO_MHL_RST,
	...
	FPGA_GPIO_07,
	FPGA_GPIO_08,
	FPGA_GPIO_WLAN_EN, //FPGA_GPIO_09,
};
