...
#if defined(CONFIG_INPUT_WACOM) 	// jjlee
static struct gpiomux_setting gsbi1_suspended_cfg = {
	.func = GPIOMUX_FUNC_GPIO, 	//GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA, 	// GPIOMUX_DRV_8MA,
...
static struct gpiomux_setting qsc2ap_vddmin_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config sglte2_qsc_configs[] __initdata = {
	...
	/* QSC2AP_VDDMIN */
	{
		.gpio = 64, 
		.settings = {
			[GPIOMUX_ACTIVE] = &qsc2ap_vddmin_cfg,		
			[GPIOMUX_SUSPENDED] = &qsc2ap_vddmin_cfg,
		}
	},
#endif
};
...
void __init apq8064_init_gpiomux(void)
{
	...
	printk("**mtp %d, JF %d\n",machine_is_apq8064_mtp(), machine_is_JF());
	...
	//			ARRAY_SIZE(bmdm_configs));
			...
			printk("**PLATFORM_SUBTYPE_SGLTE2\n");
