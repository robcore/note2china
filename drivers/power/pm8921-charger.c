...
static void check_temp_thresholds(struct pm8921_chg_chip *chip)
{
	...
	pr_debug("temp = %d, warm_thr_temp = %d, cool_thr_temp = %d, rc=%d\n",
			temp, chip->warm_temp_dc,
			chip->cool_temp_dc, rc);
...
{
	int vbat_programmed, iterm_programmed, vbat_intended = (int) 0;
	int regulation_loop = (int) 0, fast_chg = (int) 0, vcp = (int) 0;
	int rc;
