...
#define GPIO_CAM_A_EN	PM8921_GPIO_PM_TO_SYS(32)
#define GPIO_CAM_AF_EN	PM8921_GPIO_PM_TO_SYS(15)
#define GPIO_8M_CAM_RESET	PM8921_GPIO_PM_TO_SYS(6)
...
#define GPIO_CAM_FLASH_SET		PM8921_GPIO_PM_TO_SYS(3)
#define GPIO_CAM_FLASH_EN		PM8921_GPIO_PM_TO_SYS(11)
...
static struct regulator *l28, *l35, *l21;
static void cam_ldo_power_on(void)
{
	...
	/*8M D */
	printk(KERN_DEBUG "[FORTIUS] %s: 8921_l28\n", __func__);
	...
	/*IO + VT D */
	printk(KERN_DEBUG "[FORTIUS] %s: 8917_l21\n", __func__);
	l21 = regulator_get(NULL, "8921_l21");
	regulator_set_voltage(l21, 1800000, 1800000);
	ret = regulator_enable(l21);
	if (ret)
		printk(KERN_DEBUG "error enabling regulator 8917_l21\n");
	printk(KERN_DEBUG "[FORTIUS] %s: OUT\n", __func__);
	mdelay(10);
}
...
static void cam_ldo_power_on_sub(void)
{
	...
	/*8M AF */
	printk(KERN_DEBUG "[FORTIUS] %s: AF\n", __func__);
	pmic_gpio_ctrl(GPIO_CAM_AF_EN, 1);
	mdelay(10);
	
	/*8M HOST */
	printk(KERN_DEBUG "[FORTIUS] %s: 8917_l35\n", __func__);
...
{
	printk(KERN_DEBUG "[S5K6A3YX] %s: In\n", __func__);

	/* CAM_SENSOR_2.8V (CIS 2.8V)*/
	pmic_gpio_ctrl(GPIO_CAM_A_EN, 1);
	mdelay(10);

	printk(KERN_DEBUG "[S5K6A3YX] %s: OUT\n", __func__);
	mdelay(10);	
}

static void vt_cam_ldo_power_on_sub(void)
{
	int ret = 0;
	printk(KERN_DEBUG "[S5K6A3YX] %s: In\n", __func__);

	/* VT_RESET */
	pmic_gpio_ctrl(GPIO_VT_CAM_RESET, 1);	
	mdelay(10);
...
static void vt_cam_ldo_power_off(void)
{
	...
	pmic_gpio_ctrl(GPIO_VT_CAM_RESET, 0);
}
...
static struct gpio apq8064_back_cam_gpio[] = {
	...
	{GPIO_8M_CAM_RESET, GPIOF_DIR_OUT, "CAM_RESET"},
};

static struct msm_gpio_set_tbl apq8064_back_cam_gpio_set_tbl[] = {
	{GPIO_8M_CAM_RESET, GPIOF_OUT_INIT_LOW, 10000},
	{GPIO_8M_CAM_RESET, GPIOF_OUT_INIT_HIGH, 10000},
};
...
static struct gpio apq8064_front_cam_gpio[] = {
	...
	{84, GPIOF_DIR_IN, "CAMIF_I2C_DATA"},
	{85, GPIOF_DIR_IN, "CAMIF_I2C_CLK"},
	{CAMR_RSTN, GPIOF_DIR_OUT, "CAM_RESET"},
};

static struct gpio apq8064_s5k6a3yx_cam_gpio[] = {
...
static struct msm_gpio_set_tbl apq8064_s5k6a3yx_cam_gpio_set_tbl[] = {
...
static struct msm_camera_gpio_conf apq8064_s5k6a3yx_cam_gpio_conf = {
	.cam_gpiomux_conf_tbl = apq8064_cam_2d_configs,
	.cam_gpiomux_conf_tbl_size = ARRAY_SIZE(apq8064_cam_2d_configs),
	.cam_gpio_common_tbl = apq8064_common_cam_gpio,
	.cam_gpio_common_tbl_size = ARRAY_SIZE(apq8064_common_cam_gpio),
	.cam_gpio_req_tbl = apq8064_s5k6a3yx_cam_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(apq8064_s5k6a3yx_cam_gpio),
	.cam_gpio_set_tbl = apq8064_s5k6a3yx_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(apq8064_s5k6a3yx_cam_gpio_set_tbl),
};
...
static struct msm_actuator_info msm_act_main_cam_2_info = {
	...
	.bus_id			= 27,// MSM_CAMERA_SW_I2C_BUS_ID, // 27
	.vcm_pwd        = 0,
	.vcm_enable     = 0,
};
...
static struct msm_camera_sensor_flash_src msm_flash_src_s5k3h5xa = {
	...
	._fsrc.pmic_gpio_src.led_src_1 = 3, /* emitting until coming LOW signal */
	._fsrc.pmic_gpio_src.led_src_2 = 11, /* flash for a short time */
...
void __init apq8064_init_cam(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(GPIO_CAM_AF_EN, 0, GPIO_CFG_OUTPUT,
		GPIO_CFG_NO_PULL, GPIO_CFG_4MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_8M_CAM_RESET, 0, GPIO_CFG_OUTPUT,
		GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_VT_CAM_RESET, 0, GPIO_CFG_OUTPUT,
		GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA), GPIO_CFG_ENABLE);
